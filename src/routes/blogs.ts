...
blogsRouter.get('/public', async (_req: Request, res: Response): Promise<void> => {
...
blogsRouter.get('/slug/:slug', async (req: Request, res: Response): Promise<void> => {
...
blogsRouter.get('/', requireAuth, async (req: Request, res: Response): Promise<void> => {
...
// POST /blogs — create
blogsRouter.post('/', requireAuth, async (req: Request, res: Response): Promise<void> => {
...
blogsRouter.get('/:id', requireAuth, async (req: Request, res: Response): Promise<void> => {
...
blogsRouter.put('/:id', requireAuth, async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
...
// DELETE /blogs/:id
blogsRouter.delete('/:id', requireAuth, async (req: Request, res: Response): Promise<void> => {
...
blogsRouter.patch('/:id/status', requireAuth, async (req: Request, res: Response): Promise<void> => {
